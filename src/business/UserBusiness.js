...
var InvalidRequest_1 = require("../Error/InvalidRequest");
...
var UserBusiness = /** @class */ (function () {
    function UserBusiness() {
        ...
        this.createUser = function (input) { return __awaiter(_this, void 0, void 0, function () {
            var name_1, email, password, id, userDatabase, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        name_1 = input.name, email = input.email, password = input.password;
                        ...
                        return [4 /*yield*/, userDatabase.insertUser({
                                id: id,
                                name: name_1,
                                email: email,
                                password: password
                    ...
                    case 2:
                        error_1 = _a.sent();
                        throw new CustomError_1.CustomError(error_1.message || error_1.sqMessage, error_1.status);
